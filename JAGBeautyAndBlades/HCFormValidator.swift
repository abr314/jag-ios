    ...
    func validateFormSuccessful() -> Bool {
        ...
        for errorItem in array {
            ...
            if validationStatus.rowDescriptor!.tag == kEmail ||
                validationStatus.rowDescriptor!.tag == kPhone || validationStatus.rowDescriptor!.tag == kFirstName || validationStatus.rowDescriptor!.tag == kLastName || validationStatus.rowDescriptor!.tag == kPassword {
